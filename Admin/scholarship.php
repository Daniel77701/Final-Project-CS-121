        ...
        <div class="row">
            ...
            <nav id="sidebar" class="col-12 col-md-3 col-lg-2 sidebar bg-light p-3">
                <ul class="nav flex-column">
                    ...
                    <li class="nav-item"><a class="nav-link active" href="scholarship.html"><img src="icons_admin/scholarship.png" alt="Scholarship Icon"> Scholarship</a></li>
                    ...
                    <li class="nav-item"><a class="nav-link" href="useraccount.html"><img src="icons_admin/useraccount.png" alt="User Account Icon"> User Account</a></li>
