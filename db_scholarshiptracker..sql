...
-- Create a table for dashboard scholarships
CREATE TABLE IF NOT EXISTS `dashboard_scholarships` (
...
-- Create a table for dashboard schemes
...
-- Create a table for dashboard announcements
...
--table for user scholarship at schema
...
--table for user application at schema
CREATE TABLE IF NOT EXISTS `user-applications` (
    id INT PRIMARY KEY AUTO_INCREMENT,
    scholarship_id INT,
    photo_path VARCHAR(255),
